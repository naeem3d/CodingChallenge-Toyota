...
class PittsburghWeatherViewModel: ObservableObject {
    ...
    @Published var pitsbrughDataWeather: PittsburghWeather? {
           didSet {
               print("Weather Data Updated: \(pitsbrughDataWeather?.weather.first?.description ?? "No Description")")
           }
       }
    @Published var theForcastFor5Days: The5DaysForCast?
    @Published var errorMessage: String?
    @Published var city = "San Antonio" // direct initialization
    ...
    @Published var citiesArray : [CountriesList] = []
...
//    func fetchCities() {
//        citiesArray =  apiService.fetchCitiesList()
//    }
//    
